      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
          <div class="service c shadow">
            ...
            <p>The 24/7 Care app is available to download for both Apple and Android devices. Just follow the easy, step-by-step instructions to set up your account.</p>
          </div>
        </div>
